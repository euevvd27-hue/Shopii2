# storm_shopify_bot.py - Aiogram Version
import asyncio
import aiohttp
import aiofiles
import json
...
def colored_button(text, callback_data, color="blue", icon=None):
    colors = {
...
def create_button(text, callback_data, style="primary", icon=None):
    button_text = text
    if icon:
        button_text = f"{icon} {text}"
    return InlineKeyboardButton(text=button_text, callback_data=callback_data)
...
def get_main_menu():
    ...
    builder.row(
        create_button("GATES", "gates_menu", "primary", "🏰"),
        create_button("ACCOUNT", "account_menu", "primary", "👤"),
        create_button("TOOLS", "tools_menu", "primary", "🛠️"),
        create_button("PLANS", "plans_menu", "primary", "📦"),
        create_button("CLOSE", "close_menu", "danger", "❌"),
        width=3
    )
...
def get_gates_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("AUTH", "auth_menu", "primary", "🛡️"),
        create_button("CHARGE", "charge_menu", "primary", "⚡"),
        create_button("BACK", "back_main", "secondary", "🔙"),
        width=3
    )
    return builder.as_markup()
...
def get_auth_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("STRIPE AUTH", "stripe_auth_menu", "primary", "💳"),
        create_button("BRAINTREE", "braintree_menu", "primary", "🏦"),
        create_button("BACK", "gates_menu", "secondary", "🔙"),
        width=2
    )
    return builder.as_markup()
...
def get_stripe_auth_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("SINGLE", "stripe_auth_single", "success", "🔍"),
        create_button("MASS", "stripe_auth_mass", "primary", "📊"),
        create_button("BACK", "auth_menu", "secondary", "🔙"),
        width=3
    )
    return builder.as_markup()
...
def get_braintree_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("SINGLE", "braintree_single", "success", "🔍"),
        create_button("BACK", "auth_menu", "secondary", "🔙"),
        width=2
    )
    return builder.as_markup()
...
def get_charge_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("SHOPIFY", "shopify_menu", "primary", "🛍️"),
        create_button("RAZORPAY", "razorpay_menu", "primary", "🇮🇳"),
        create_button("PAYPAL $1", "paypal_1", "primary", "💵"),
        create_button("PAYPAL $0.01", "paypal_01", "primary", "🪙"),
        create_button("STRIPE $5", "stripe_5", "primary", "💰"),
        create_button("DONATION", "donation", "success", "❤️"),
        create_button("PAYFLOW", "payflow", "primary", "🌊"),
        create_button("AUTHORIZE", "authorize", "primary", "🏛️"),
        create_button("AUTHORIZE AUTH", "authorize_auth", "primary", "🔐"),
        create_button("BACK", "gates_menu", "secondary", "🔙"),
        width=3
    )
    return builder.as_markup()
...
def get_shopify_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("SINGLE", "shopify_single", "success", "🔍"),
        create_button("MASS", "shopify_mass", "primary", "📊"),
        create_button("BACK", "charge_menu", "secondary", "🔙"),
        width=3
    )
    return builder.as_markup()
...
def get_razorpay_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("SINGLE", "razorpay_single", "success", "🔍"),
        create_button("MASS", "razorpay_mass", "primary", "📊"),
        create_button("BACK", "charge_menu", "secondary", "🔙"),
        width=3
    )
    return builder.as_markup()
...
def get_account_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("PROFILE", "profile_info", "primary", "👤"),
        create_button("PLANS", "plans_menu", "primary", "📦"),
        create_button("REDEEM", "redeem_menu", "success", "🔑"),
        create_button("BACK", "back_main", "secondary", "🔙"),
        width=3
    )
    return builder.as_markup()
...
def get_tools_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("PROXY", "proxy_menu", "primary", "🌐"),
        create_button("SITES", "sites_menu", "primary", "🌍"),
        create_button("BROADCAST", "broadcast_menu", "primary", "📢"),
        create_button("BACK", "back_main", "secondary", "🔙"),
        width=3
    )
    return builder.as_markup()
...
def get_proxy_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("ADD PROXY", "add_proxy", "success", "➕"),
        create_button("VIEW PROXY", "view_proxy", "primary", "👁️"),
        create_button("REMOVE PROXY", "remove_proxy", "danger", "➖"),
        create_button("BACK", "tools_menu", "secondary", "🔙"),
        width=2
    )
    return builder.as_markup()
...
def get_sites_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("ADD SITES", "add_sites", "success", "➕"),
        create_button("VIEW SITES", "view_sites", "primary", "👁️"),
        create_button("REMOVE SITES", "remove_sites", "danger", "➖"),
        create_button("BACK", "tools_menu", "secondary", "🔙"),
        width=2
    )
    return builder.as_markup()
...
def get_plans_menu():
    builder = InlineKeyboardBuilder()
    builder.row(
        create_button("1 DAY - ₹20", "plan_1day", "primary", "📅"),
        create_button("1 WEEK - ₹100", "plan_1week", "primary", "📆"),
        create_button("1 MONTH - ₹300", "plan_1month", "primary", "📅"),
        create_button("2 MONTH - ₹550", "plan_2month", "primary", "📆"),
        create_button("BACK", "account_menu", "secondary", "🔙"),
        width=2
    )
    return builder.as_markup()
...
<b>━━━━━━━━━━━━━━━━━</b>"""
    builder = InlineKeyboardBuilder()
    builder.row(create_button(f"{get_live_emoji('back')} BACK", "account_menu", "secondary", "🔙"))
    await callback.message.edit_text(premium_emoji(msg_text), reply_markup=builder.as_markup())
    await callback.answer()
...
async def add_proxy_cb(callback: CallbackQuery):
    msg_text = f"""{get_live_emoji('proxy')} <b>{bold_text('ADD PROXY')}</b>

{bold_text('Send the proxy in format:')}
<code>ip:port</code> or <code>ip:port:username:password</code>

{bold_text('Or use /addpxy command.')}"""
    builder = InlineKeyboardBuilder()
    builder.row(create_button(f"{get_live_emoji('back')} BACK", "proxy_menu", "secondary", "🔙"))
    await callback.message.edit_text(premium_emoji(msg_text), reply_markup=builder.as_markup())
    await callback.answer()

@dp.callback_query(lambda c: c.data == "view_proxy")
async def view_proxy_cb(callback: CallbackQuery):
    user_id = callback.from_user.id
    proxies = load_proxies()
    if not proxies:
        await callback.answer("No proxies available", show_alert=True)
        return
    if len(proxies) <= 20:
        proxy_list = "\n".join([f"• <code>{p}</code>" for p in proxies[:20]])
        msg_text = f"{get_live_emoji('proxy')} <b>{bold_text('PROXY LIST')}</b>\n\n{proxy_list}\n\n<b>Total:</b> {len(proxies)}"
        builder = InlineKeyboardBuilder()
        builder.row(create_button(f"{get_live_emoji('back')} BACK", "proxy_menu", "secondary", "🔙"))
        await callback.message.edit_text(premium_emoji(msg_text), reply_markup=builder.as_markup())
    else:
        ...
        await callback.message.reply_document(FSInputFile(filename), caption=f"{get_live_emoji('proxy')} <b>{bold_text('PROXY LIST')}</b>\n\n<b>Total:</b> {len(proxies)}")
        try:
            os.remove(filename)
        except:
            pass
...
@dp.callback_query(lambda c: c.data == "remove_proxy")
async def remove_proxy_cb(callback: CallbackQuery):
    msg_text = f"""{get_live_emoji('proxy')} <b>{bold_text('REMOVE PROXY')}</b>

{bold_text('Send the proxy to remove:')}
<code>/rmproxy ip:port</code> or <code>/rmproxyindex 1,2,3</code>

{bold_text('Or use /clearproxy to clear all.')}"""
    builder = InlineKeyboardBuilder()
    builder.row(create_button(f"{get_live_emoji('back')} BACK", "proxy_menu", "secondary", "🔙"))
    await callback.message.edit_text(premium_emoji(msg_text), reply_markup=builder.as_markup())
    await callback.answer()

@dp.callback_query(lambda c: c.data == "add_sites")
async def add_sites_cb(callback: CallbackQuery):
    msg_text = f"""{get_live_emoji('tools')} <b>{bold_text('ADD SITES')}</b>

{bold_text('Send a .txt file with sites (one per line) using /tas')}
{bold_text('Or add a single site with /addsite https://site.com')}"""
    builder = InlineKeyboardBuilder()
    builder.row(create_button(f"{get_live_emoji('back')} BACK", "sites_menu", "secondary", "🔙"))
    await callback.message.edit_text(premium_emoji(msg_text), reply_markup=builder.as_markup())
    await callback.answer()

@dp.callback_query(lambda c: c.data == "view_sites")
async def view_sites_cb(callback: CallbackQuery):
    user_id = callback.from_user.id
    sites = load_sites()
    if not sites:
        await callback.answer("No sites available", show_alert=True)
        return
    if len(sites) <= 20:
        site_list = "\n".join([f"• <code>{s}</code>" for s in sites[:20]])
        msg_text = f"{get_live_emoji('tools')} <b>{bold_text('SITE LIST')}</b>\n\n{site_list}\n\n<b>Total:</b> {len(sites)}"
        builder = InlineKeyboardBuilder()
        builder.row(create_button(f"{get_live_emoji('back')} BACK", "sites_menu", "secondary", "🔙"))
        await callback.message.edit_text(premium_emoji(msg_text), reply_markup=builder.as_markup())
    else:
        ...
        await callback.message.reply_document(FSInputFile(filename), caption=f"{get_live_emoji('tools')} <b>{bold_text('SITE LIST')}</b>\n\n<b>Total:</b> {len(sites)}")
        try:
            os.remove(filename)
        except:
            pass
...
@dp.callback_query(lambda c: c.data == "remove_sites")
async def remove_sites_cb(callback: CallbackQuery):
    msg_text = f"""{get_live_emoji('tools')} <b>{bold_text('REMOVE SITES')}</b>

{bold_text('Remove a single site with /rm https://site.com')}
{bold_text('Or run /fuck to remove all dead sites.')}"""
    builder = InlineKeyboardBuilder()
    builder.row(create_button(f"{get_live_emoji('back')} BACK", "sites_menu", "secondary", "🔙"))
    await callback.message.edit_text(premium_emoji(msg_text), reply_markup=builder.as_markup())
    await callback.answer()
